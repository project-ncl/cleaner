...
public class RoleOperations {
    ...
    public static List<ObjectNode> getCompositeRealmRolesForUserAsNodes(String rootUrl,
                                                                        String realm,
                                                                        String userid,
                                                                        String auth) {
    ...
    public static List<ObjectNode> getAvailableRealmRolesForUserAsNodes(String rootUrl,
                                                                        String realm,
                                                                        String userid,
                                                                        String auth) {
    ...
    public static List<ObjectNode> getClientRolesForUserAsNodes(String rootUrl,
                                                                String realm,
                                                                String userid,
                                                                String idOfClient,
                                                                String auth) {
    ...
    public static List<ObjectNode> getCompositeClientRolesForUserAsNodes(String rootUrl,
                                                                         String realm,
                                                                         String userid,
                                                                         String idOfClient,
                                                                         String auth) {
        String resourceUrl = composeResourceUrl(rootUrl,
                                                realm,
                                                "users/" + userid + "/role-mappings/clients/" + idOfClient + "/composite");
        return doGetJSON(LIST_OF_NODES.class, resourceUrl, auth);
    }

    public static List<ObjectNode> getAvailableClientRolesForUserAsNodes(String rootUrl,
                                                                         String realm,
                                                                         String userid,
                                                                         String idOfClient,
                                                                         String auth) {
    ...
    public static List<ObjectNode> getCompositeRealmRolesForGroupAsNodes(String rootUrl,
                                                                         String realm,
                                                                         String groupid,
                                                                         String auth) {
    ...
    public static List<ObjectNode> getAvailableRealmRolesForGroupAsNodes(String rootUrl,
                                                                         String realm,
                                                                         String groupid,
                                                                         String auth) {
    ...
    public static List<ObjectNode> getClientRolesForGroupAsNodes(String rootUrl,
                                                                 String realm,
                                                                 String groupid,
                                                                 String idOfClient,
                                                                 String auth) {
    ...
    public static List<ObjectNode> getCompositeClientRolesForGroupAsNodes(String rootUrl,
                                                                          String realm,
                                                                          String groupid,
                                                                          String idOfClient,
                                                                          String auth) {
    ...
    public static List<ObjectNode> getAvailableClientRolesForGroupAsNodes(String rootUrl,
                                                                          String realm,
                                                                          String groupid,
                                                                          String idOfClient,
                                                                          String auth) {
