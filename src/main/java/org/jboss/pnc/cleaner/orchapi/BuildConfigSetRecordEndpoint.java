...
public interface BuildConfigSetRecordEndpoint {
    ...
    Response getAllTemporaryOlderThanTimestamp(@QueryParam(PAGE_INDEX_QUERY_PARAM) int pageIndex,
            @QueryParam(PAGE_SIZE_QUERY_PARAM) int pageSize, @QueryParam(SORTING_QUERY_PARAM) String sort,
            @QueryParam(QUERY_QUERY_PARAM) String q, @QueryParam("timestamp") long timestamp);
}
