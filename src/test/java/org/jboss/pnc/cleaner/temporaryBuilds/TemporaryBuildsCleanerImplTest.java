...
public class TemporaryBuildsCleanerImplTest {
    ...
    public void shouldDeleteATemporaryBuild() {
        ...
        wireMockServer.stubFor(delete(urlMatching(BUILDS_ENDPOINT + buildId
                + "\\?callback=0\\.0\\.0\\.0%3A8080%2Fcallbacks%2Fbuild-record-delete%2F100")).willReturn(aResponse().withStatus(200)));
    ...
    public void shouldAddAuthorizationHeadersWhenDeleting() {
        ...
        wireMockServer.verify(1,
                              deleteRequestedFor(urlMatching(BUILDS_ENDPOINT
    ...
    public void shouldDeleteATemporaryBuildGroup() {
        ...
        wireMockServer.stubFor(delete(urlMatching(BUILDS_GROUPS_ENDPOINT + buildId
                + "\\?callback=0\\.0\\.0\\.0%3A8080%2Fcallbacks%2Fbuild-group-record-delete%2F102")).willReturn(aResponse().withStatus(200)));
